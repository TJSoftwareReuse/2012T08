...
public class Server {
    ...
    public static LisenceClass license;
    ...
    private static void initLicense()
    {
        ...
        if(LNum!=null)
        {
            license = new LisenceClass();
            license.resetLisenceNum(LNum);
        }
    ...
    public class WorkerThread extends Thread{
        ...
        protected synchronized void ProvideService(String str) {
            PM.sendPMMessage("get Message "+str, 1);
            if(license.useLisence())
            {
